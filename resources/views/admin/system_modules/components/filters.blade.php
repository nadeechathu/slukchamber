...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body text-start">
            <form action="{{route('admin.system-modules.all')}}" method="get" enctype="multipart/form-data">
            <div class="form-group">
                <label>Filter by Module name</label>
            ...
            <div class="form-group">
                ...
                <a href="{{route('admin.system-modules.all')}}"><button type="button" class="btn btn-primary btn-search w-100 mt-1"><i class="fa fa-refresh"></i> Reset Filters</button></a>
            </div>
            </form>
        </div>
