...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body text-start">
            <form action="{{route('admin.components.all')}}" method="get" enctype="multipart/form-data">
            <div class="form-group">
                <label>Filter by component name</label>
            ...
            <div class="form-group">
                ...
                <a href="{{route('admin.components.all')}}"><button type="button" class="btn btn-primary btn-search w-100 mt-1"><i class="fa fa-refresh"></i> Reset Filters</button></a>
            </div>
            </form>
        </div>
