...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body text-start">
            <form action="{{route('admin.elements.all')}}" method="get" enctype="multipart/form-data">
            <div class="form-group">
                <label>Filter by element name</label>
            ...
            <div class="form-group">
                ...
                <a href="{{route('admin.elements.all')}}"><button type="button" class="btn btn-primary btn-search w-100 mt-1"><i class="fa fa-refresh"></i> Reset Filters</button></a>
            </div>
            </form>
        </div>
